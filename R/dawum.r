...
DAWUM <- fromJSON( file = 'data/dawum.json')
...
write.csv( DAWUM$Database, file = 'data/Database.csv'
 )

# "Parliaments" 

write.csv( get_parliaments(DAWUM$Parliaments)
           , file = 'data/Parliaments.csv'
           , row.names = FALSE
 )
...
write.csv( get_parties(DAWUM$Parties)
           , file = 'data/Parties.csv'
           , row.names = FALSE
 )
